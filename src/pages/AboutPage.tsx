      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Tabs defaultValue="history" className="w-full max-w-4xl mx-auto">
            <TabsList className="flex w-full justify-center gap-2 mb-8 bg-white p-2 rounded-xl border border-rosalex-gray-100 shadow-sm">
              <TabsTrigger 
                value="history" 
                className="flex-1 text-base font-semibold px-6 py-3 rounded-lg transition-all duration-200 border border-transparent data-[state=active]:bg-gradient-to-r data-[state=active]:from-rosalex-pink-100 data-[state=active]:to-rosalex-gray-50 data-[state=active]:text-rosalex-pink-800 data-[state=active]:border-rosalex-pink-300 bg-white text-rosalex-gray-700 hover:bg-rosalex-pink-50 hover:text-rosalex-pink-700"
              ...
              <div className="bg-white/90 rounded-xl shadow-lg p-8 max-w-4xl mx-auto border border-rosalex-gray-100">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="order-2 md:order-1 rounded-lg overflow-hidden shadow-lg">
                    <img 
                      src="public/IMG/IMG-20250731-WA0005.jpg" 
